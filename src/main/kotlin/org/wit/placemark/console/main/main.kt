...
//import sun.jvm.hotspot.runtime.PerfMemory.start
...
//
//    do {
//        input = collegeView.menu()
//        when(input) {
//            1 -> addCollege()
//            2 -> addCourse()
//            3 -> addModule()
//            4 -> collegeView.listColleges(colleges)
//            5 -> listCourses()
//            6 -> listModules()
//            7 -> searchCollege()
//            8 -> collegeView.deleteCollegeData()
//            9 -> updateCollege()
...
//        college.id = colleges.colleges.size.toLong()
//        colleges.colleges.add(college.copy())
...
//    if (collegeView.addCollegeData(aCollege) && aCollege.address.length == 7){
...
//    var foundCollege: CollegeModel? = colleges.colleges.find { p -> p.id == id }
//    return foundCollege
//}
//
//fun searchCollege() {
...
//        colleges.colleges.remove(colleges.colleges.get(searchId.toInt()))
//    }
//    else {
